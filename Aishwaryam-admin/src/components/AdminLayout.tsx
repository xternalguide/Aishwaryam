...
export const AdminLayout: React.FC<AdminLayoutProps> = ({ currentTab, setCurrentTab, children }) => {
  ...
  const navItems: SidebarItem[] = [
    ...
    { id: 'redemptions', label: 'Redemptions', icon: <Gift size={18} /> },
    { id: 'enrollments', label: 'Scheme Enrollments', icon: <UserCheck size={18} /> },
    { id: 'schemes', label: 'Scheme Master', icon: <Settings size={18} /> },
    { id: 'offers', label: 'Offers & Promos', icon: <FileText size={18} /> },
